...
class AdvisorsControllerTest < ActionController::TestCase
  ...
  test "should create advisor" do
    assert_difference('Advisor.count') do
      post :create, advisor: { domain_name: @advisor.domain_name, first_name: @advisor.first_name, last_name: @advisor.last_name }
    end
  ...
  test "should update advisor" do
    patch :update, id: @advisor, advisor: { domain_name: @advisor.domain_name, first_name: @advisor.first_name, last_name: @advisor.last_name }
    assert_redirected_to advisor_path(assigns(:advisor))
  end
